...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'articles', 'locations', ['primary_location_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key(None, 'articles', 'characters', ['primary_character_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key(None, 'articles', 'users', ['last_modified_by_user_id'], ['id'])
    op.create_foreign_key(None, 'articles', 'factions', ['primary_faction_id'], ['id'], ondelete='SET NULL')
    ...
    op.create_index('idx_faction_structure', 'faction_culture', ['internal_structure'], unique=False, postgresql_using='gin')
...
def downgrade() -> None:
    ...
    op.drop_constraint(None, 'articles', type_='foreignkey')
    op.drop_constraint(None, 'articles', type_='foreignkey')
    op.create_foreign_key(op.f('articles_primary_race_id_fkey'), 'articles', 'races', ['primary_race_id'], ['id'])
    op.create_foreign_key(op.f('articles_primary_faction_id_fkey'), 'articles', 'factions', ['primary_faction_id'], ['id'])
    op.create_foreign_key(op.f('articles_primary_location_id_fkey'), 'articles', 'locations', ['primary_location_id'], ['id'])
    op.create_foreign_key(op.f('articles_primary_character_id_fkey'), 'articles', 'characters', ['primary_character_id'], ['id'])
