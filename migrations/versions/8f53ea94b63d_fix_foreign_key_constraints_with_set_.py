...
def upgrade() -> None:
    ...
    op.add_column(
        "articles", sa.Column("last_modified_by_user_id", sa.Integer(), nullable=True)
    )
    op.create_index(
    ...
    op.drop_constraint(
        op.f("articles_primary_character_id_fkey"), "articles", type_="foreignkey"
    )
    op.drop_constraint(
        op.f("articles_primary_location_id_fkey"), "articles", type_="foreignkey"
    )
    op.drop_constraint(
        op.f("articles_primary_faction_id_fkey"), "articles", type_="foreignkey"
    )
    op.drop_constraint(
        op.f("articles_primary_race_id_fkey"), "articles", type_="foreignkey"
    )
    ...
    op.create_foreign_key(
        None, "articles", "users", ["last_modified_by_user_id"], ["id"]
    )
    op.create_foreign_key(
        None,
        "articles",
    ...
    op.create_foreign_key(
        None, "articles", "races", ["primary_race_id"], ["id"], ondelete="SET NULL"
    )
    op.drop_constraint(
        op.f("characters_race_id_fkey"), "characters", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "characters", "races", ["race_id"], ["id"], ondelete="SET NULL"
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        op.f("characters_race_id_fkey"), "characters", "races", ["race_id"], ["id"]
    )
